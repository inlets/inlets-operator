...
type TunnelInterface interface {
	Create(ctx context.Context, tunnel *v1alpha1.Tunnel, opts v1.CreateOptions) (*v1alpha1.Tunnel, error)
	Update(ctx context.Context, tunnel *v1alpha1.Tunnel, opts v1.UpdateOptions) (*v1alpha1.Tunnel, error)
	UpdateStatus(ctx context.Context, tunnel *v1alpha1.Tunnel, opts v1.UpdateOptions) (*v1alpha1.Tunnel, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.Tunnel, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.TunnelList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Tunnel, err error)
	TunnelExpansion
}
...
func newTunnels(c *OperatorV1alpha1Client, namespace string) *tunnels {
	return &tunnels{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *tunnels) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Tunnel, err error) {
...
func (c *tunnels) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TunnelList, err error) {
...
func (c *tunnels) Create(ctx context.Context, tunnel *v1alpha1.Tunnel, opts v1.CreateOptions) (result *v1alpha1.Tunnel, err error) {
	result = &v1alpha1.Tunnel{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tunnels").
...
func (c *tunnels) Update(ctx context.Context, tunnel *v1alpha1.Tunnel, opts v1.UpdateOptions) (result *v1alpha1.Tunnel, err error) {
	result = &v1alpha1.Tunnel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tunnels").
...
func (c *tunnels) UpdateStatus(ctx context.Context, tunnel *v1alpha1.Tunnel, opts v1.UpdateOptions) (result *v1alpha1.Tunnel, err error) {
	result = &v1alpha1.Tunnel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tunnels").
...
func (c *tunnels) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Tunnel, err error) {
	result = &v1alpha1.Tunnel{}
